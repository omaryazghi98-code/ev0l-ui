...
export const HYPERBEAM_URL = 'https://engine.hyperbeam.com/v0/vm'
export const SIMKL_CLIENT_ID = import.meta.env.VITE_SIMKL_CLIENT_ID?.trim() || ''
export const SIMKL_REDIRECT_URI = import.meta.env.VITE_SIMKL_REDIRECT_URI?.trim() || ''